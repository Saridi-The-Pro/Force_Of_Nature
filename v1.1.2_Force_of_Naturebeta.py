    ...
    if declaration == "yes":
        ...
        while hero.health > 0 and enemy.health > 0:
            ...
            if hero_action == "attack":
                damage = randint(*hero.weapon_damage)  # Using the weapon's specific damage range
                enemy.health -= damage
                sleep(2)
                ...
                if hero.special_power == "Fire":
                    ...
                    if enemy.special_power == "Fire" or enemy.special_power == "Lightning" or enemy.special_power == "Earth":
                        ...
                        sleep(2)
                        print(f"Your water power makes enemy cold for {water_damage} extra damage!")
                    hero.health += heal
                    sleep(2)
                    ...
                    sleep(2)
                    print(f"Your ice power makes enemy hypothermic for {freezing_damage} extra damage!")
                    if randint(1,4) == 1:
                    ...
                    enemy.health -= burn_damage
                    sleep(2)
                    print(f"Your lightning power creates fire that burns the enemy for {burn_damage} extra damage!")
                    if enemy.special_power == "Water":
                        if randint(1,2) == 1:
                            enemy.is_frozen = True
                            print("Your lightning power shocks the enemy too! They lose their next turn!")
                    if randint(1,3) == 2:
                        enemy.is_frozen = True
                        print("Your lightning power shocks the enemy! They lose their next turn!")
                elif hero.special_power == "Earth":
                    puncture_damage = 3
                    enemy.health -= puncture_damage
                    sleep(2)
                    print(f"Your earth power impales the enemy for {puncture_damage} extra damage!")
                    if randint(1,3) == 2:
                        enemy.is_frozen = True
                        sleep(2)
                        print("Your earth power creates a barrier that holds the enemy's attack")
                        if randint(1,3) == 2:
                            puncture_damage += 4
                            enemy.is_frozen = True
                            sleep(2)
                            print(f"Your earth power bounces the enemy because the attack is below them for {puncture_damage} extra damage!")
                elif hero.special_power == "Wind":
                    wind_damage = 3
                    enemy.health -= wind_damage
                    sleep(2)
                    print(f"Your wind power pushes the enemy for {wind_damage} extra damage!")
                    if enemy.special_power == "Lightning":
                        burn_damage = burn_damage / 2
                        print("Enemy's burn damage has been divided by 2!!")
            ...
            if not enemy.is_frozen:
                ...
                if enemy.special_power == "Fire":
                    ...
                    if hero.special_power == "Fire" or hero.special_power == "Lightning" or hero.special_power == "Earth":
                        ...
                        sleep(2)
                        print(f"Enemy's water power makes you cold for {water_damage} extra damage!")
                    enemy.health += heal
                    sleep(2)
                    ...
                    sleep(2)
                    print(f"Enemy's ice power makes you hypothermic for {freezing_damage} extra damage!")
                    if randint(1,4) == 1:
                        enemy.is_frozen = True
                        sleep(2)
                    ...
                    hero.health -= burn_damage
                    sleep(2)
                    print(f"The enemy's lightning power creates fire that burns you for {burn_damage} extra damage!")
                    if hero.special_power == "Water":
                        if randint(1,2) == 1:
                            hero.is_frozen = True
                            print("The enemy's lightning power shocks you too! You lose your next turn!")
                    if randint(1,3) == 2:
                        hero.is_frozen = True
                        print("The enemy's lightning power shocks you! You lose your next turn!")
                elif enemy.special_power == "Earth":
                    puncture_damage = 3
                    hero.health -= puncture_damage
                    sleep(2)
                    print(f"The enemy's earth power impales you for {puncture_damage} extra damage!")
                    if randint(1,3) == 2:
                        hero.is_frozen = True
                        sleep(2)
                        print("The enemy's earth power creates a barrier that holds your attack")
                        if randint(1,3) == 2:
                            puncture_damage += 4
                            hero.is_frozen = True
                            sleep(2)
                            print(f"The enemy's earth power bounces you because the attack is below you for {puncture_damage} extra damage!")
                elif enemy.special_power == "Wind":
                    wind_damage = 3
                    hero.health -= wind_damage
                    sleep(2)
                    print(f"Enemy's wind power pushes you for {wind_damage} extra damage!")
                    if hero.special_power == "Lightning":
                        burn_damage = burn_damage / 2
                        print("Your burn damage has been divided by 2!!")
            else:
                sleep(2)
